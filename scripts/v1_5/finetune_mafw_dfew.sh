CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed facellava/train/train_mem.py \
    ...
    --version v1 \
    --data_path /wekafs/ict/achaubey/emotion_reasoning/code/data_preprocess/instruct_files_final/train_sets/affectnet_bp4d_au.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints_final/facellava-7b-affectnet_bp4d_au_lr2e-5 \
    --num_train_epochs 1 \
