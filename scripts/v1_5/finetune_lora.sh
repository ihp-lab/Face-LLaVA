...
CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 HF_DATASETS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 deepspeed facellava/train/train_mem.py \
    ...
    --model_name_or_path /wekafs/ict/achaubey/emotion_reasoning/code/Video-LLaVA/checkpoints/facellava-7b \
    --version v1 \
    --data_path /wekafs/ict/achaubey/emotion_reasoning/code/data_preprocess/instruct_files/mafw_dfew_ferv39k_balanced_10k.json \
    ...
    --bf16 True \
    --output_dir ./checkpoints/facellava-7b-lora_wo_proj_wts_mafw_dfew_ferv39k_10k \
    --num_train_epochs 1 \
